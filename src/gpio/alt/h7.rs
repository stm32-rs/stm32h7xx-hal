...
pub mod octospim {
    ...
    impl OctospiPort for crate::pac::OCTOSPI1 {
        type Clk = P1Clk;
        type Nclk = P1Nclk;
        type Dqs = P1Dqs;
        type Ncs = P1Ncs;
    ...
    impl OctospiPort for crate::pac::OCTOSPI2 {
        type Clk = P2Clk;
        type Nclk = P2Nclk;
        type Dqs = P2Dqs;
        type Ncs = P2Ncs;
...
pub mod quadspi {
    ...
    pin! {
        ...
        <Bk1Io2, PushPull> for no:NoPin, [
            PE2<9>,

            PF7<9>,
        ],

        <Bk1Io3, PushPull> for no:NoPin, [
            PA1<9>,
        ...
        <Bk2Io0, PushPull> for no:NoPin, [
            PE7<10>,

            PH2<9>,
        ],

        <Bk2Io1, PushPull> for no:NoPin, [
            PE8<10>,

            PH3<9>,
        ],

        <Bk2Io2, PushPull> for no:NoPin, [
            PE9<10>,

            PG9<9>,
        ],

        <Bk2Io3, PushPull> for no:NoPin, [
            PE10<10>,
...
pub mod sdmmc1 {
    ...
    use crate::pac::SDMMC1 as SDMMC;
    impl SdmmcCommon for SDMMC {
        type Ck = Ck;
        type Cmd = Cmd;
        type D0 = D0;
        type D1 = D1;
