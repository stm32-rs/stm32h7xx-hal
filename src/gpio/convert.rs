...
impl<const P: char, const N: u8, const A: u8, MODE>
    From<Pin<P, N, Output<MODE>>> for Pin<P, N, Alternate<A, PushPull>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8, const A: u8, const B: u8>
    From<Pin<P, N, Alternate<B, OpenDrain>>>
    for Pin<P, N, Alternate<A, PushPull>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8, const A: u8, MODE>
    From<Pin<P, N, Output<MODE>>> for Pin<P, N, Alternate<A, OpenDrain>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Output<MODE>>) -> Self {
        f.into_alternate_open_drain::<A>()
...
impl<const P: char, const N: u8> From<Pin<P, N, Input<Floating>>>
...
impl<const P: char, const N: u8> From<Pin<P, N, Input<PullUp>>>
    for Pin<P, N, Input<PullDown>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8> From<Pin<P, N, Analog>>
    for Pin<P, N, Input<PullDown>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Analog>) -> Self {
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Input<PullDown>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Input<PullDown>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8> From<Pin<P, N, Input<PullDown>>>
    for Pin<P, N, Input<PullUp>>
{
    #[inline(always)]
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Input<PullUp>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, PushPull>>) -> Self {
        f.into_pull_up_input()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Input<PullUp>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, OpenDrain>>) -> Self {
        f.into_pull_up_input()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Input<Floating>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, PushPull>>) -> Self {
        f.into_floating_input()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Input<Floating>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, OpenDrain>>) -> Self {
        f.into_floating_input()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Output<OpenDrain>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, PushPull>>) -> Self {
        f.into_open_drain_output()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Output<OpenDrain>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, OpenDrain>>) -> Self {
        f.into_open_drain_output()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Output<PushPull>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, PushPull>>) -> Self {
        f.into_push_pull_output()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Output<PushPull>>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, OpenDrain>>) -> Self {
        f.into_push_pull_output()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, PushPull>>> for Pin<P, N, Analog>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, PushPull>>) -> Self {
        f.into_analog()
...
impl<const P: char, const N: u8, const A: u8>
    From<Pin<P, N, Alternate<A, OpenDrain>>> for Pin<P, N, Analog>
{
    #[inline(always)]
    fn from(f: Pin<P, N, Alternate<A, OpenDrain>>) -> Self {
        f.into_analog()
    ...
    pub(super) fn mode<M: PinMode>(&mut self) {
        ...
        unsafe {
            (*Gpio::<P>::ptr()).pupdr.modify(|r, w| {
                w.bits((r.bits() & !(0b11 << offset)) | (M::PUPDR << offset))
            });
            ...
            (*Gpio::<P>::ptr()).moder.modify(|r, w| {
                w.bits((r.bits() & !(0b11 << offset)) | (M::MODER << offset))
            });
        }
    }
}
