...
impl defmt::Format for ResetReason {
    fn format(&self, f: defmt::Formatter<'_>) {
        match self {
            ResetReason::PowerOnReset => defmt::write!(f, "Power-on reset (pwr_por_rst)"),
            ResetReason::PinReset => defmt::write!(f, "Pin reset (NRST)"),
            ResetReason::BrownoutReset => defmt::write!(f, "Brownout reset (pwr_bor_rst)"),
            ResetReason::SystemReset => defmt::write!(f, "System reset generated by CPU (SFTRESET)"),
            ResetReason::CpuReset => defmt::write!(f, "CPU reset (CPURST)"),
            ResetReason::WindowWatchdogReset => defmt::write!(f, "WWDG1 reset (wwdg1_out_rst)"),
            ResetReason::IndependentWatchdogReset => defmt::write!(f, "IWDG1 reset (iwdg1_out_rst)"),
            ResetReason::GenericWatchdogReset => defmt::write!(f, "IWDG1 or WWDG1 reset"),
            ResetReason::D1ExitsDStandbyMode => defmt::write!(f, "D1 exits DStandby mode"),
            ResetReason::D2ExitsDStandbyMode => defmt::write!(f, "D2 exits DStandby mode"),
            ResetReason::D1EntersDStandbyErroneouslyOrCpuEntersCStopErroneously => defmt::write!(
                f,
                "D1 erroneously enters DStandby mode or CPU erroneously enters CStop mode"
            ),
