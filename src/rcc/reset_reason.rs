...
pub enum ResetReason {
    ...
    CpuReset,
    /// The window watchdog got angry
    WindowWatchdogReset,
    /// The independant watchdog got angry
    IndependantWatchdogReset,
    /// Any of the two watchdogs got angry (but we don't know which one)
...
impl Display for ResetReason {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            ResetReason::IndependantWatchdogReset => write!(f, "IWDG1 reset (iwdg1_out_rst)"),
