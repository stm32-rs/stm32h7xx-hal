...
mod pdm;
pub use pdm::{PdmInstance, SaiPdmExt};
mod i2s;
pub use i2s::{
    I2SChanConfig, I2SClockStrobe, I2SCompanding, I2SComplement, I2SDataSize,
    I2SDir, I2SMode, I2SProtocol, I2SSync, I2sInstance, I2sUsers, SaiI2sExt,
    I2S,
};
...
impl<SAI, INTERFACE> Sai<SAI, INTERFACE>
where
    SAI: core::ops::Deref<Target = crate::pac::sai1::RegisterBlock> + GetClkSAI,
{
    /// Low level RCC initialisation
    fn sai_rcc_init(&mut self, prec: SAI::Rec) {
